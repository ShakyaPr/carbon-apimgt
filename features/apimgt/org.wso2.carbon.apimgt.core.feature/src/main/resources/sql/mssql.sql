...
CREATE TABLE AM_API_SEQUENCE_BACKEND (
    ...
    SEQUENCE VARBINARY(MAX) NOT NULL,
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_ORGANIZATION_MAPPING]') AND TYPE IN (N'U'))
CREATE TABLE AM_ORGANIZATION_MAPPING (
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[AM_KEY_MANAGER_ALLOWED_ORGS]') AND type in (N'U'))
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_API_EXTERNAL_API_MAPPING]') AND TYPE IN (N'U'))
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_LABEL]') AND TYPE IN (N'U'))
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_API_LABEL_MAPPING]') AND TYPE IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_RULESET]') AND TYPE IN (N'U'))
CREATE TABLE GOV_RULESET (
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_RULESET_CONTENT]') AND TYPE IN (N'U'))
CREATE TABLE GOV_RULESET_CONTENT (
     RULESET_ID VARCHAR(36) NOT NULL,
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_RULESET_RULE]') AND TYPE IN (N'U'))
CREATE TABLE GOV_RULESET_RULE (
      RULESET_RULE_ID VARCHAR(36) NOT NULL,
      RULESET_ID VARCHAR(36) NOT NULL,
      RULE_NAME VARCHAR(256) NOT NULL,
      RULE_DESCRIPTION VARCHAR(1024),
      SEVERITY VARCHAR(32) NOT NULL,
      RULE_CONTENT VARBINARY(MAX) NOT NULL,
      FOREIGN KEY (RULESET_ID) REFERENCES GOV_RULESET(RULESET_ID),
      CONSTRAINT RULESET_RULE_CONSTRAINT UNIQUE (RULESET_ID, RULE_NAME),
      PRIMARY KEY (RULESET_RULE_ID)
);

IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_POLICY]') AND TYPE IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_POLICY_LABEL]') AND TYPE IN (N'U'))
CREATE TABLE GOV_POLICY_LABEL (
    POLICY_ID VARCHAR(36) NOT NULL,
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_POLICY_GOVERNABLE_STATE]') AND TYPE IN (N'U'))
CREATE TABLE GOV_POLICY_GOVERNABLE_STATE (
    POLICY_ID VARCHAR(36) NOT NULL,
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_POLICY_ACTION]') AND TYPE IN (N'U'))
CREATE TABLE GOV_POLICY_ACTION (
    POLICY_ID VARCHAR(36) NOT NULL,
    STATE VARCHAR(128) NOT NULL,
    SEVERITY VARCHAR(32) NOT NULL,
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_POLICY_RULESET]') AND TYPE IN (N'U'))
CREATE TABLE GOV_POLICY_RULESET (
    POLICY_ID VARCHAR(36) NOT NULL,
    RULESET_ID VARCHAR(36) NOT NULL,
    FOREIGN KEY (POLICY_ID) REFERENCES GOV_POLICY(POLICY_ID),
    FOREIGN KEY (RULESET_ID) REFERENCES GOV_RULESET(RULESET_ID),
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_ARTIFACT]') AND TYPE IN (N'U'))
CREATE TABLE GOV_ARTIFACT (
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_REQUEST]') AND TYPE IN (N'U'))
CREATE TABLE GOV_REQUEST (
    REQ_ID VARCHAR(36) NOT NULL,
    ARTIFACT_KEY VARCHAR(36) NOT NULL,
    STATUS VARCHAR(32) NOT NULL DEFAULT 'PENDING',
    REQ_TIMESTAMP DATETIME DEFAULT GETDATE(),
    PROCESSING_TIMESTAMP DATETIME,
    CONSTRAINT EVAL_CONSTRAINT UNIQUE (STATUS, ARTIFACT_KEY),
    PRIMARY KEY (REQ_ID)
);

IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_REQUEST_POLICY]') AND TYPE IN (N'U'))
CREATE TABLE GOV_REQUEST_POLICY (
    REQ_ID VARCHAR(36) NOT NULL,
    POLICY_ID VARCHAR(36) NOT NULL,
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_POLICY_RUN]') AND TYPE IN (N'U'))
CREATE TABLE GOV_POLICY_RUN (
    ARTIFACT_KEY VARCHAR(36) NOT NULL,
    POLICY_ID VARCHAR(36) NOT NULL,
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_RULESET_RUN]') AND TYPE IN (N'U'))
CREATE TABLE GOV_RULESET_RUN (
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[GOV_RULE_VIOLATION]') AND TYPE IN (N'U'))
CREATE TABLE GOV_RULE_VIOLATION (
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_ARTIFACT]') AND TYPE IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_DEVPORTAL_ORG_CONTENT]') AND TYPE IN (N'U'))
CREATE TABLE AM_DEVPORTAL_ORG_CONTENT (
    ORGANIZATION       NVARCHAR(100),
    DRAFTED_ARTIFACT   NVARCHAR(45),
    PUBLISHED_ARTIFACT NVARCHAR(45),
    PRIMARY KEY (ORGANIZATION),
    FOREIGN KEY (DRAFTED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE CASCADE ON UPDATE SET NULL,
    FOREIGN KEY (PUBLISHED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE CASCADE ON UPDATE SET NULL
);

IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_DEVPORTAL_API_CONTENT]') AND TYPE IN (N'U'))
CREATE TABLE AM_DEVPORTAL_API_CONTENT (
    API_UUID           NVARCHAR(256),
    ORGANIZATION       NVARCHAR(100),
    DRAFTED_ARTIFACT   NVARCHAR(45),
    PUBLISHED_ARTIFACT NVARCHAR(45),
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_DEVPORTAL_API_REFERENCE]') AND TYPE IN (N'U'))
CREATE TABLE AM_DEVPORTAL_API_REFERENCE (
    API_UUID        NVARCHAR(256),
    ORGANIZATION    NVARCHAR(100) NOT NULL,
    REFERENCE_APIID NVARCHAR(256) NOT NULL,
    PRIMARY KEY (API_UUID, ORGANIZATION)
);
