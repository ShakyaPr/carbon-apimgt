...
CREATE TABLE AM_API (
    ...
    API_TYPE VARCHAR2(10),
    API_SUBTYPE VARCHAR2(10),
    ORGANIZATION VARCHAR(100),
...
CREATE SEQUENCE AM_API_PRIMARY_EP_MAPPING_seq START WITH 1 INCREMENT BY 1 CACHE 20 ORDER
/
CREATE OR REPLACE TRIGGER AM_API_PRIMARY_EP_MAPPING_seq_tr
    BEFORE INSERT ON AM_API_PRIMARY_EP_MAPPING FOR EACH ROW
...
CREATE SEQUENCE AM_ALERT_TYPES_SEQ START WITH 1 INCREMENT BY 1 CACHE 20
/
...
CREATE SEQUENCE AM_ALERT_EMAILLIST_SEQ START WITH 1 INCREMENT BY 1 CACHE 20
/
...
CREATE TABLE AM_POLICY_SUBSCRIPTION (
	    ...
	    BILLING_PLAN VARCHAR2(20),
            ...
            TOTAL_TOKEN_COUNT NUMBER(19),
            PROMPT_TOKEN_COUNT NUMBER(19),
            COMPLETION_TOKEN_COUNT NUMBER(19),
...
CREATE TABLE AM_API_CLIENT_CERTIFICATE (
  ...
  KEY_TYPE VARCHAR2(20) DEFAULT 'PRODUCTION' NOT NULL,
  REVISION_UUID VARCHAR2(255) DEFAULT 'Current API' NOT NULL,
  FOREIGN KEY (API_ID) REFERENCES AM_API (API_ID) ON DELETE CASCADE,
...
CREATE SEQUENCE AM_SYSTEM_APPS_SEQ START WITH 1 INCREMENT BY 1 CACHE 20
/
...
CREATE TABLE AM_SCOPE (
            ...
            PRIMARY KEY (SCOPE_ID))
/
CREATE SEQUENCE AM_SCOPE_SEQUENCE START WITH 1 INCREMENT BY 1 CACHE 20 ORDER
/
...
/
CREATE SEQUENCE AM_GATEWAY_ENV_SEQ START WITH 1 INCREMENT BY 1 CACHE 20 ORDER
/
...
CREATE SEQUENCE AM_WEBHOOKS_SUBSCRIPTION_SEQ START WITH 1 INCREMENT BY 1 CACHE 20 ORDER
/
...
/
-- Generate ID using sequence and trigger
CREATE SEQUENCE AM_LLM_PROVIDER_MODEL_seq START WITH 1 INCREMENT BY 1 CACHE 20 ORDER
/
CREATE OR REPLACE TRIGGER AM_LLM_PROVIDER_MODEL_seq_tr
 BEFORE INSERT ON AM_LLM_PROVIDER_MODEL FOR EACH ROW
...
CREATE TABLE GOV_RULESET (
    RULESET_ID VARCHAR2(36) NOT NULL,
    NAME VARCHAR2(256) NOT NULL,
    DESCRIPTION VARCHAR2(1024),
    ARTIFACT_TYPE VARCHAR2(128) NOT NULL,
    RULE_CATEGORY VARCHAR2(128) NOT NULL,
    RULE_TYPE VARCHAR2(128) NOT NULL,
    DOCUMENTATION_LINK VARCHAR2(1024),
...
CREATE TABLE GOV_RULESET_RULE (
    RULESET_RULE_ID VARCHAR2(36) NOT NULL,
    RULESET_ID VARCHAR2(36) NOT NULL,
    RULE_NAME VARCHAR2(256) NOT NULL,
    RULE_DESCRIPTION VARCHAR2(1024),
...
CREATE TABLE GOV_ARTIFACT (
    ARTIFACT_KEY VARCHAR2(36) NOT NULL,
    ARTIFACT_REF_ID VARCHAR2(36) NOT NULL,
...
CREATE TABLE GOV_RULESET_RUN (
    RULESET_RUN_ID VARCHAR2(36) NOT NULL,
    ARTIFACT_KEY VARCHAR2(36) NOT NULL,
    RULESET_ID VARCHAR2(36) NOT NULL,
...
CREATE TABLE GOV_RULE_VIOLATION (
    ...
    VIOLATED_PATH VARCHAR2(1024) NOT NULL,
    PRIMARY KEY (ID),
...
CREATE TABLE AM_DEVPORTAL_ORG_CONTENT (
    ORGANIZATION VARCHAR2(100),
    DRAFTED_ARTIFACT VARCHAR2(45),
    PUBLISHED_ARTIFACT VARCHAR2(45),
    PRIMARY KEY (ORGANIZATION),
    CONSTRAINT FK_DRAFTED_ORG FOREIGN KEY (DRAFTED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE SET NULL,
    CONSTRAINT FK_PUBLISHED_ORG FOREIGN KEY (PUBLISHED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE SET NULL
)
/
...
CREATE TABLE AM_DEVPORTAL_API_CONTENT (
    ...
    CONSTRAINT FK_DRAFTED_API FOREIGN KEY (DRAFTED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE SET NULL,
    CONSTRAINT FK_PUBLISHED_API FOREIGN KEY (PUBLISHED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE SET NULL
)
/
...
CREATE TABLE AM_DEVPORTAL_API_REFERENCE (
    ...
    REFERENCE_APIID VARCHAR2(256) NOT NULL,
    PRIMARY KEY (API_UUID, ORGANIZATION)
) 
/
