...
CREATE TABLE AM_LLM_PROVIDER_MODEL (
    MODEL_ID INTEGER GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
...
CREATE TABLE AM_DEVPORTAL_ORG_CONTENT (
    ...
    FOREIGN KEY (DRAFTED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE SET NULL,
    FOREIGN KEY (PUBLISHED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE SET NULL
)
/
